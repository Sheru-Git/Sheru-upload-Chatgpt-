...
async def upload_with_split(bot, chat_id, file_path, caption=""):
    import os
    from utils import split_file_ffmpeg
    ...
    if file_size <= MAX_SIZE:
        ...
        parts = split_file_ffmpeg(file_path, MAX_SIZE)
        for idx, part in enumerate(parts, start=1):
            part_caption = f"{caption} (Part {idx})"
            await bot.send_document(chat_id, part, caption=part_caption)
